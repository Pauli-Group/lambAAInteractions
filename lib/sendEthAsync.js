...
const sendEthAsync = (_accountName, toAddress, amount) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const callData = accountInterface_1.default.encodeFunctionData('asyncTransfer', [
        toAddress,
        amount,
    ]);
