...
function generateNewCounterfactual(blockchain, accountName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const accountImplementation = yield factory.accountImplementation();
        { // generate the byte code needed to verify the proxy contract
            const bytecode = ethers_1.ethers.utils.defaultAbiCoder.encode(['address', 'bytes'], [
                accountImplementation,
                accountInterface_1.default.encodeFunctionData('initialize', [
                    ecdsaSigner.address,
                    initialKeyHashes,
                ])
            ]);
