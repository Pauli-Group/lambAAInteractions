...
function loadAccount(accountName) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const oceKeys = (_a = selectedAccount.oceKeys) === null || _a === void 0 ? void 0 : _a.map((k) => Object.assign(new KeyTrackerB_1.default(), JSON.parse(JSON.stringify(k))));
        return Object.assign(Object.assign({}, selectedAccount), { keys: kt, oceKeys: oceKeys });
    });
}
